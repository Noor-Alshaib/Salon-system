...
public class appointmentManagement extends JFrame {
    ...
    public appointmentManagement(String userEmail) {
        ...
        subTextLabel.setForeground(new Color(255, 105, 180));
        ...
        myAppointmentsButton.setBackground(new Color(255, 105, 180));
        ...
        availableAppointmentsButton.setBackground(new Color(255, 105, 180));
